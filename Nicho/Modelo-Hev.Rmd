...
```{r}
datos <- read.csv("Datos-HeV/HeV-survival.csv")
...
wireframe(log10(Sup) ~ Temp + Tiempo, data = datos.nuevos,
          drape = T)
```
...
Fin de la parte I, [regresar a la página principal del curso](../../index.html)